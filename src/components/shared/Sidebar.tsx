...
const navigation: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { title: 'Stock Report', href: '/dashboard/inventory/stock-report' },
    ],
  },
  {
    title: 'Sales Barcode',
  ...
  },
  {
    ...
    children: [
      ...
      { title: 'Item-wise Report', href: '/dashboard/reports/items' },
      { title: 'Purchase Report', href: '/dashboard/reports/purchases' },
      { title: 'Profit Report', href: '/dashboard/reports/profit' },
    ],
  },
  {
    title: 'Settings',
